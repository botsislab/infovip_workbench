<template>
  <div>
    <h2>Country Derived</h2>
    <div class="card">
      <div class="dull">Number of Reports for Country Derived</div>
...
export default {
  ...
  methods: {
    ...
    processData (serviceData) {
      ...
      let groupedCounts = DataMunger.getGroupedCounts(serviceData, 'Country Derived')
